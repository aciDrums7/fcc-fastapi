...
from . import models, crud, schemas, exception_handling
from .exception_handling import NotFoundException
...
@app.get("/posts/latest", response_model=Union[schemas.Post, None])
